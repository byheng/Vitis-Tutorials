...
#
# zcu106_custom_platform.tcl: Tcl script for re-creating project 'zcu106_custom_platform'
#
# Generated by Vivado on Mon May 12 16:53:19 CST 2025
...
#
# 1. This project restoration tcl script (zcu106_custom_platform.tcl) that was generated.
#
...
set _xil_proj_name_ "zcu106_custom_platform"
...
set script_file "zcu106_custom_platform.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/WorkSpace/zcu106_hardware_platform"]"
...
set_property -name "platform.name" -value "zcu106_custom_platform" -objects $obj
...
set_property PFM_NAME "xilinx:zcu106:zcu106_custom_platform:0.0" [get_files system.bd ] 
...
if { [get_property IS_LOCKED [ get_files -norecurse system.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/WorkSpace/zcu106_hardware_platform/zcu106_custom_platform.gen/sources_1/bd/system/hdl/system_wrapper.v" ]
} else {
